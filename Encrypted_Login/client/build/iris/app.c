...
extern void *memset(void *arg_0x7f61d871a150, int arg_0x7f61d871a3d0, size_t arg_0x7f61d871a690);
...
typedef int (*__compar_fn_t)(const void *arg_0x7f61d86f8970, const void *arg_0x7f61d86f8c70);
...
typedef TMilli ClientC__SendKey__precision_tag;
typedef TMilli ClientC__SendPass__precision_tag;
typedef CyberMsg ClientC__ReceiveW__t;
typedef TMilli ClientC__LookForHost__precision_tag;
...
typedef CyberMsg /*ClientAppC.AMReceiverWC*/AMReceiverWC__0__t;
typedef /*ClientAppC.AMReceiverWC*/AMReceiverWC__0__t /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__t;
typedef /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__t /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveUpperL__t;
...
static void ClientC__SendKey__fired(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void ClientC__AMControl__startDone(error_t error);
#line 138
static void ClientC__AMControl__stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void ClientC__Boot__booted(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void ClientC__sendMsg_AgreeKey__runTask(void );
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void ClientC__SendPass__fired(void );
# 2 "ReceiveW.nc"
static void ClientC__ReceiveW__receive(ClientC__ReceiveW__t msg);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void ClientC__LookForHost__fired(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void ClientC__sendMsg_FindHost__runTask(void );
#line 75
static void ClientC__sendMsg_SendyPassy__runTask(void );
...
/*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveLowerL__receive(
#line 71
message_t * msg, 
void * payload, 
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void ClientC__SendKey__startPeriodic(uint32_t dt);
#line 78
static void ClientC__SendKey__stop(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t ClientC__AMControl__start(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t ClientC__sendMsg_AgreeKey__postTask(void );
...
uint8_t len);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void ClientC__SendPass__startPeriodic(uint32_t dt);
#line 78
static void ClientC__SendPass__stop(void );
# 61 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void ClientC__Leds__led0Off(void );
...
static void ClientC__Leds__led1On(void );
...
static void ClientC__Leds__led1Toggle(void );
#line 77
static void ClientC__Leds__led1Off(void );
#line 56
static void ClientC__Leds__led0On(void );
#line 89
static void ClientC__Leds__led2On(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void ClientC__LookForHost__startPeriodic(uint32_t dt);
#line 78
static void ClientC__LookForHost__stop(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t ClientC__sendMsg_FindHost__postTask(void );
#line 67
static error_t ClientC__sendMsg_SendyPassy__postTask(void );
# 68 "ClientC.nc"
enum ClientC____nesc_unnamed4336 {
#line 68
  ClientC__sendMsg_FindHost = 0U
};
#line 68
typedef int ClientC____nesc_sillytask_sendMsg_FindHost[ClientC__sendMsg_FindHost];
#line 87
enum ClientC____nesc_unnamed4337 {
#line 87
  ClientC__sendMsg_AgreeKey = 1U
};
#line 87
typedef int ClientC____nesc_sillytask_sendMsg_AgreeKey[ClientC__sendMsg_AgreeKey];
#line 106
enum ClientC____nesc_unnamed4338 {
#line 106
  ClientC__sendMsg_SendyPassy = 2U
};
#line 106
typedef int ClientC____nesc_sillytask_sendMsg_SendyPassy[ClientC__sendMsg_SendyPassy];
#line 15
uint32_t ClientC__password;
uint32_t ClientC__key = KEY_CLIENT;
uint32_t ClientC__host_key = 0;

bool ClientC__login_success = FALSE;

uint8_t ClientC__hostID = 0;

bool ClientC__busy = FALSE;

message_t ClientC__pkt;


static inline void ClientC__establishHost(void );




static inline void ClientC__establishKey(void );



static inline void ClientC__sendPassword(void );



static inline void ClientC__encryptPass(void );
...
static inline void ClientC__AMControl__startDone(error_t err);
...
static inline void ClientC__AMControl__stopDone(error_t err);

static inline void ClientC__AMSend__sendDone(message_t *msg, error_t err);





static inline void ClientC__sendMsg_FindHost__runTask(void );
#line 87
static inline void ClientC__sendMsg_AgreeKey__runTask(void );
#line 106
static inline void ClientC__sendMsg_SendyPassy__runTask(void );
#line 127
static inline void ClientC__LookForHost__fired(void );
...
static inline void ClientC__SendKey__fired(void );
...
static inline void ClientC__SendPass__fired(void );
...
static inline void ClientC__ReceiveW__receive(CyberMsg msg);
# 65 "/opt/tinyos-2.1.2/tos/lib/rfxlink/util/RadioAlarm.nc"
...
static error_t /*ClientAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
# 2 "ReceiveW.nc"
static void /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveUpperL__receive(/*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveUpperL__t msg);
# 6 "AMReceiverWP.nc"
/*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__t /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__RxMessage;

static inline message_t */*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveLowerL__receive(message_t *msg, void *payload, uint8_t len);
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f61d765ac40, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f61d765ac40) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f61d765ac40, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f61d7659e80, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__AMSend__send(arg_0x7f61d7659e80, addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__SendNotifier__aboutToSend(am_id_t arg_0x7f61d80c5450, am_addr_t dest, message_t * msg){
#line 59
    /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__SendNotifier__default__aboutToSend(arg_0x7f61d80c5450, dest, msg);
#line 59
}
#line 59
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__requested(uint8_t arg_0x7f61d7fe8cf0){
#line 53
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__requested(arg_0x7f61d7fe8cf0);
#line 53
}
#line 53
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x7f61d7fe5450){
#line 59
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__configure(arg_0x7f61d7fe5450);
#line 59
}
#line 59
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x7f61d7fe8cf0){
#line 61
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x7f61d7fe8cf0);
#line 61
}
#line 61
...
# 60 "/opt/tinyos-2.1.2/tos/lib/rfxlink/util/RadioAlarm.nc"
inline static void /*RF230RadioC.RadioAlarmC.RadioAlarmP*/RadioAlarmP__0__RadioAlarm__fired(uint8_t arg_0x7f61d81167e0){
#line 60
  switch (arg_0x7f61d81167e0) {
#line 60
    case 0U:
#line 60
...
#line 60
    default:
#line 60
      /*RF230RadioC.RadioAlarmC.RadioAlarmP*/RadioAlarmP__0__RadioAlarm__default__fired(arg_0x7f61d81167e0);
#line 60
      break;
#line 60
    }
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool Atm128SpiP__ResourceArbiter__isOwner(uint8_t arg_0x7f61d78fd280){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__isOwner(arg_0x7f61d78fd280);
#line 128
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x7f61d7fe5450){
#line 59
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__default__configure(arg_0x7f61d7fe5450);
#line 59
}
#line 59
# 169 "/opt/tinyos-2.1.2/tos/system/SimpleArbiterP.nc"
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x7f61d7fe8cf0){
#line 61
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x7f61d7fe8cf0);
#line 61
}
#line 61
# 84 "/opt/tinyos-2.1.2/tos/system/SimpleArbiterP.nc"
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__immediateRequest(uint8_t arg_0x7f61d78fd280){
#line 97
  unsigned char __nesc_result;
#line 97

#line 97
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__immediateRequest(arg_0x7f61d78fd280);
#line 97
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__requested(uint8_t arg_0x7f61d7fe8cf0){
#line 53
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__default__requested(arg_0x7f61d7fe8cf0);
#line 53
}
#line 53
# 71 "/opt/tinyos-2.1.2/tos/system/SimpleArbiterP.nc"
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__request(uint8_t arg_0x7f61d78fd280){
#line 88
  unsigned char __nesc_result;
#line 88

#line 88
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__request(arg_0x7f61d78fd280);
#line 88
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x7f61d7fe5450){
#line 65
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x7f61d7fe5450);
#line 65
}
#line 65
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void Atm128SpiP__Resource__granted(uint8_t arg_0x7f61d791bb70){
#line 102
  switch (arg_0x7f61d791bb70) {
#line 102
    case 0U:
#line 102
...
#line 102
    default:
#line 102
      Atm128SpiP__Resource__default__granted(arg_0x7f61d791bb70);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__granted(uint8_t arg_0x7f61d7fe9a50){
#line 102
  Atm128SpiP__ResourceArbiter__granted(arg_0x7f61d7fe9a50);
#line 102
}
#line 102
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x7f61d7fe5450){
#line 65
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x7f61d7fe5450);
#line 65
}
#line 65
# 68 "/opt/tinyos-2.1.2/tos/system/FcfsResourceQueueC.nc"
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__release(uint8_t arg_0x7f61d78fd280){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__release(arg_0x7f61d78fd280);
#line 120
...
#line 89
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void ClientC__SendKey__startPeriodic(uint32_t dt){
#line 64
...
#line 33
{
  ClientC__SendKey__startPeriodic(RESEND_PERIOD);
}
...
# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void ClientC__LookForHost__stop(void ){
#line 78
...
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t ClientC__sendMsg_FindHost__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(ClientC__sendMsg_FindHost);
#line 67
...
inline static void ClientC__Leds__led1Toggle(void ){
#line 83
...
#line 127
{
  ClientC__Leds__led1Toggle();
  if (ClientC__hostID == 0) {
      ClientC__sendMsg_FindHost__postTask();
    }
  else {
      ClientC__LookForHost__stop();
      ClientC__establishKey();
    }
}

# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void ClientC__SendPass__startPeriodic(uint32_t dt){
#line 64
...
#line 37
{
  ClientC__SendPass__startPeriodic(RESEND_PERIOD);
}

# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void ClientC__SendKey__stop(void ){
#line 78
...
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t ClientC__sendMsg_AgreeKey__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(ClientC__sendMsg_AgreeKey);
#line 67
...
#line 138
{
  if (ClientC__host_key == 0) {
      ClientC__sendMsg_AgreeKey__postTask();
    }
  else {
      ClientC__SendKey__stop();
      ClientC__sendPassword();
    }
}

# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void ClientC__SendPass__stop(void ){
#line 78
...
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t ClientC__sendMsg_SendyPassy__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(ClientC__sendMsg_SendyPassy);
#line 67
...
#line 148
{
  if (ClientC__login_success == FALSE) {
      ClientC__sendMsg_SendyPassy__postTask();
    }
  else {
      ClientC__SendPass__stop();
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f61d7b2da40){
#line 83
  switch (arg_0x7f61d7b2da40) {
#line 83
    case 0U:
#line 83
      ClientC__LookForHost__fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      ClientC__SendKey__fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      ClientC__SendPass__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f61d7b2da40);
#line 83
      break;
#line 83
    }
...
#line 138
  ClientC__AMControl__stopDone(error);
#line 138
}
#line 138
#line 104
inline static error_t ClientC__AMControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void ClientC__LookForHost__startPeriodic(uint32_t dt){
#line 64
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void ClientC__Leds__led0Off(void ){
#line 61
...
#line 28
{
  ClientC__Leds__led0Off();
  ClientC__LookForHost__startPeriodic(RESEND_PERIOD);
}
...
{
  if (err == SUCCESS) {
      ClientC__establishHost();
    }
  else {
      ClientC__AMControl__start();
    }
}
...
#line 113
  ClientC__AMControl__startDone(error);
#line 113
}
#line 113
# 144 "/opt/tinyos-2.1.2/tos/lib/rfxlink/layers/MessageBufferLayerP.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__AMSend__sendDone(am_id_t arg_0x7f61d80c9960, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f61d80c9960, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__SnoopDefault__receive(am_id_t arg_0x7f61d80c4cf0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__SnoopDefault__default__receive(arg_0x7f61d80c4cf0, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__Snoop__receive(am_id_t arg_0x7f61d80c7890, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__Snoop__default__receive(arg_0x7f61d80c7890, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__ReceiveDefault__receive(am_id_t arg_0x7f61d80c40d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__ReceiveDefault__default__receive(arg_0x7f61d80c40d0, msg, payload, len);
#line 78
...
inline static void ClientC__Leds__led2On(void ){
#line 89
  LedsP__Leds__led2On();
#line 89
}
...
inline static void ClientC__Leds__led1On(void ){
#line 72
  LedsP__Leds__led1On();
#line 72
}
...
#line 41
{
  ClientC__password = PASSWD ^ ClientC__key;
}
...
inline static void ClientC__Leds__led1Off(void ){
#line 77
...
inline static void ClientC__Leds__led0On(void ){
#line 56
  LedsP__Leds__led0On();
#line 56
}
...
#line 157
{
  if (__nesc_ntoh_uint8(msg.mode.nxdata) == GETHOSTMODE && __nesc_ntoh_uint8(msg.destination.nxdata) == TOS_NODE_ID) {
      ClientC__hostID = __nesc_ntoh_uint8(msg.from.nxdata);
      ClientC__Leds__led0On();
      ClientC__Leds__led1Off();
    }
  else {
#line 163
    if (__nesc_ntoh_uint8(msg.mode.nxdata) == GETKEYMODE && __nesc_ntoh_uint8(msg.destination.nxdata) == TOS_NODE_ID) {
        ClientC__host_key = __nesc_ntoh_uint32(msg.key.nxdata);
        ClientC__encryptPass();
        ClientC__Leds__led1On();
      }
    else {
#line 168
      if (__nesc_ntoh_uint8(msg.mode.nxdata) == GETLOGIN && __nesc_ntoh_uint8(msg.destination.nxdata) == TOS_NODE_ID) {
          ClientC__login_success = TRUE;
          ClientC__Leds__led2On();
        }
      }
    }
}
...
# 2 "ReceiveW.nc"
inline static void /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveUpperL__receive(/*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveUpperL__t msg){
#line 2
  ClientC__ReceiveW__receive(msg);
#line 2
}
#line 2
# 8 "AMReceiverWP.nc"
...
#line 8
{
  if (len == sizeof(/*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__t )) {
      /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__t *btrpkt = (/*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__t *)payload;

#line 11
      /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__RxMessage = *btrpkt;

      /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveUpperL__receive(/*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__RxMessage);
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__Receive__receive(am_id_t arg_0x7f61d80c8c90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f61d80c8c90) {
#line 78
    case 6UL:
#line 78
      __nesc_result = /*ClientAppC.AMReceiverWC.AMReceiverWP*/AMReceiverWP__0__ReceiveLowerL__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = /*RF230RadioC.ActiveMessageLayerC.ActiveMessageLayerP*/ActiveMessageLayerP__0__Receive__default__receive(arg_0x7f61d80c8c90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__Resource__granted(uint8_t arg_0x7f61d7fe9a50){
#line 102
  switch (arg_0x7f61d7fe9a50) {
#line 102
    case 0U:
#line 102
...
#line 102
    default:
#line 102
      /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__Resource__default__granted(arg_0x7f61d7fe9a50);
#line 102
      break;
#line 102
    }
...
{
  if (!ClientC__busy) {
      CyberMsg *btrpkt = (CyberMsg *)ClientC__Packet__getPayload(&ClientC__pkt, sizeof(CyberMsg ));
...
#line 109
      ...
      __nesc_hton_uint8(btrpkt->mode.nxdata, SENDPASSMODE);
      __nesc_hton_uint8(btrpkt->from.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(btrpkt->destination.nxdata, ClientC__hostID);
      __nesc_hton_uint32(btrpkt->key.nxdata, 0);
      __nesc_hton_uint32(btrpkt->password.nxdata, ClientC__password);

      if (ClientC__AMSend__send(AM_BROADCAST_ADDR, &ClientC__pkt, sizeof(CyberMsg )) == SUCCESS) {
          ClientC__busy = TRUE;
        }
    }
}
...
#line 90
      ...
      __nesc_hton_uint8(btrpkt->mode.nxdata, SENDKEYMODE);
      __nesc_hton_uint8(btrpkt->from.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(btrpkt->destination.nxdata, ClientC__hostID);
      __nesc_hton_uint32(btrpkt->key.nxdata, ClientC__key);
...
#line 71
      ...
      __nesc_hton_uint8(btrpkt->mode.nxdata, SENDHOSTMODE);
      __nesc_hton_uint8(btrpkt->from.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(btrpkt->destination.nxdata, 0);
      __nesc_hton_uint32(btrpkt->key.nxdata, 0);
      __nesc_hton_uint32(btrpkt->password.nxdata, 0);
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f61d85b76a0){
#line 75
  switch (arg_0x7f61d85b76a0) {
#line 75
    case ClientC__sendMsg_FindHost:
#line 75
      ClientC__sendMsg_FindHost__runTask();
#line 75
      break;
#line 75
    case ClientC__sendMsg_AgreeKey:
#line 75
      ClientC__sendMsg_AgreeKey__runTask();
#line 75
      break;
#line 75
    case ClientC__sendMsg_SendyPassy:
#line 75
      ClientC__sendMsg_SendyPassy__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x7f61d85b76a0);
#line 75
      break;
#line 75
    }
...
#line 55
{
  ...
  /*ClientAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 6UL);
